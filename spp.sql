...
--
-- Host: localhost:3306
-- Generation Time: Feb 18, 2025 at 03:48 AM
...
ALTER TABLE `pembayaran`
  ...
  ADD CONSTRAINT `pembayaran_ibfk_3` FOREIGN KEY (`id_spp`) REFERENCES `siswa` (`id_spp`) ON DELETE RESTRICT ON UPDATE RESTRICT;
